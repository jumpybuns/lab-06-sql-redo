...
app.get('/shielas', async(req, res) => {
  try {
    ...
    select shielas.id, shielas.name, categories.category as category 
    from shielas 
    join categories 
    on categories.id = shielas.category_id order by categories.category desc
    `);
...
app.get('/shielas/:id', async(req, res) => {
  try {
    ...
    from shielas 
    join categories 
    on categories.id = shielas.category_id
